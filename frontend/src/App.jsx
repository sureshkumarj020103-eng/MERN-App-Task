...
export default function App() {
  ...
  const fetchHistory = useCallback(async () => {
    try {
      const res = await fetch(import.meta.env.VITE_REACT_APP_BACKEND_URL + '/api/history');
  ...
  const runFlow = async () => {
    ...
    try {
      const response = await fetch(import.meta.env.VITE_REACT_APP_BACKEND_URL + '/api/ask-ai', {
        method: 'POST',
  ...
  const saveCurrent = async () => {
    ...
    try {
      const response = await fetch(import.meta.env.VITE_REACT_APP_BACKEND_URL + '/api/save', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
